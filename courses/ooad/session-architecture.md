...
- **S08 — Holistic design judgment:** 여러 설계 대안을 Change Impact, Cohesion, Coupling, Dependency, Abstraction Cost, SOLID, Pattern과 Trade-off 관점에서 종합 비교한다. S07에서 만든 local refinement와 Pattern vocabulary를 일반적인 설계 대안 평가 능력으로 확장한다.
