...
- **S09 — Integrated design workshop:** 요구·정적/동적 분석·책임·협력·계약·variation과 대안 평가를 하나의 일관된 설계 판단으로 통합한다. S08의 alternative evaluation을 새로운 local refinement로 되돌리거나 S09 workshop을 선행하지 않는다.
