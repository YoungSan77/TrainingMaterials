# AI-Native Software Engineering — Practice Design

> **Course ID:** ai-native
> **Owns (`guides/과정_설계_지침.md` §2-b):** 실제 실습 시나리오 목록(Practice ID·제목) · Course Ownership 경계 · Work Context / Decision Practiced · Preconditions / Inputs / Deliverable / Timebox · Initial Instruction · Intervention · Evidence of Learning · Recommended Prompt + Prompt Design Intent · Trade-off / Failure Condition / Transfer.
> **Field spec authority:** `portfolio/practice-standard.md` §6(Required Practice Specification) — 필드 상세·운영 규칙은 이 문서가 아니라 그 문서가 정본이다.
> **Legacy migration provenance:** context v2.6 Instructor-only Course Asset의 8개 Practice를 축약 없이 흡수했다. 원출처는 Git history에 보존된다.
> **Asset Class:** Instructor-only Course Asset — Recommended Prompt와 Intervention을 포함한 전체 내용을 실습 전에 학습자에게 배포하지 않는다(`portfolio/practice-standard.md` §2).
> **Practice Count:** 8 (Baseline 대비 8/8, 누락 없음)
> **Cadence:** Day 1 4개 / Day 2 4개
> **Practice Time:** 약 180분, 기존 instructional time에 포함(추가 운영시간으로 붙이지 않는다)
> **Authority:** 과정 Baseline과 공통 Governance(`portfolio/practice-standard.md`)에 종속; 충돌 시 상위 Canon 우선
...
| Field | Content |
|---|---|
| **Practice ID / Title** | P1 — Choose the Simplest Execution Form |
| **Placement** | T02 (Baseline Topic 배치 참고치 — 확정 세션 번호는 Stage 2 소유) |
| **Timebox** | 20분 |
| **Course Ownership** | Execution-form Selection (AI-Native OWNER) |
...
| Field | Content |
|---|---|
| **Practice ID / Title** | P2 — Specification before Delegation |
| **Placement** | T03 |
| **Timebox** | 25분 |
| **Course Ownership** | Specification Engineering (AI-Native OWNER) |
...
| Field | Content |
|---|---|
| **Practice ID / Title** | P3 — Context, not Prompt Tuning |
| **Placement** | T04/T05 |
| **Timebox** | 25분 |
| **Course Ownership** | Context Engineering (AI-Native OWNER) |
...
| Field | Content |
|---|---|
| **Practice ID / Title** | P4 — Guardrail before Autonomy |
| **Placement** | T06 |
| **Timebox** | 20분 |
| **Course Ownership** | Guardrail (AI-Native OWNER) |
...
| Field | Content |
|---|---|
| **Practice ID / Title** | P5 — Harness / Workflow Contract |
| **Placement** | T07/T10 |
| **Timebox** | 25분 |
| **Course Ownership** | Harness / Workflow (AI-Native OWNER) |
...
| Field | Content |
|---|---|
| **Practice ID / Title** | P6 — Agent or Workflow? Autonomy & HITL |
| **Placement** | T09/T11 |
| **Timebox** | 20분 |
| **Course Ownership** | Agent / HITL (AI-Native OWNER) |
...
| Field | Content |
|---|---|
| **Practice ID / Title** | P7 — Evaluation & Observability |
| **Placement** | T13/T14 |
| **Timebox** | 25분 |
| **Course Ownership** | AI Evaluation (AI-Native OWNER) |
...
| Field | Content |
|---|---|
| **Practice ID / Title** | P8 — Integrated Execution-form Redesign |
| **Placement** | T15/T16 |
| **Timebox** | 20분 |
| **Course Ownership** | Integrated AI-Native Decision (AI-Native OWNER) |
...
## Practice ↔ Exercise Evidence Cross-reference

`course-context.md` §11(Exercise Evidence Categories, Baseline §9)과의 연결 — 어떤 Practice가 어떤 Evidence 범주를 주로 생성하는지.

| Exercise Evidence Category | Primary Practice |
|---|---|
| Human vs Agent R&R | P1 |
| Specification | P2 |
| Context Set | P3 |
| Guardrail | P4 |
| Harness Flow / Tool Permission Model | P5 |
| HITL Point / Autonomy Rationale | P6 |
| Deterministic Gate / Probabilistic Evaluation | P7 |
| Failure Path / Observability Fields | P5, P7 |
| Autonomy Rationale (재선택) | P8 |
...
- 이 문서는 `01_llm-integrated-practice-pack-v1.1.md`의 축약 없는 재구성이며 새 Practice를 추가하거나 기존 Practice를 삭제하지 않는다.
- Course Ownership Rule(`portfolio/practice-standard.md` §9): LLM을 사용한다는 이유로 Concept OWNER가 AI-Native로 이동하지 않는다. 다른 과정에서 AI-Native 개념이 필요할 경우 최소 RECAP/APPLY만 사용한다.
- Conflict 시 `portfolio/practice-standard.md` > Baseline > 이 문서 순으로 우선한다.
