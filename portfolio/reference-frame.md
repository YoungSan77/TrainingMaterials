...
## 0. Curriculum Design Starting Point — Learner & Context Fit

Portfolio의 출발점은 우리가 알고 있는 Body of Knowledge가 아니라 **학습자가 실제 업무에서 더 잘 내려야 할 결정과 Capability Gap**이다.
...
모든 Course는 필요에 따라 다음 5개 상위 Lens를 APPLY한다. 이들은 성숙도 단계나 순차 방법론이 아니다.

1. **Systems Thinking** — 전체, 상호작용, feedback, delay, socio-technical structure
2. **Lean Thinking** — value, flow, waste, batch, built-in quality
3. **Theory of Constraints** — 현재 전체 성과를 제한하는 constraint
...
- **Modern SWQM** --- 다른 과정의 기술 개념을 재정의하지 않고, Prevention / Verification / Evidence / Gate / Feedback / Continuous Improvement 관점에서 전체 Engineering System의 품질을 다룬다.
...
## 2A. Unified Portfolio Snapshot v2.2

### Developed Baseline
| Course | Time | Primary Ownership |
|---|---:|---|
| OOAD | 16h | Responsibility / Object Contract / Collaboration |
| DDD | 8h | Domain Model / Invariant / Bounded Context |
| SW Architecture | 16h | Structural Decision / Quality Trade-off / Evolution |
| MSA | 8h | Distribution / Service Contract / Failure / Operation |
| AI-Native | 16h | Delegation / Context / Guardrail / Harness / Evaluation |
| Modern SWQM | 8h | Prevention / Evidence / Quality Gate / Improvement |
| Agile | 8h | Adaptive Delivery / Feedback / Scrum Adoption |

### Additional Baseline Courses
DevOps / SW Project Management / SW Proposal / DT→AX.

Agile은 Engineering track의 다음 단계가 아니라 **Adaptive Delivery 관점의 독립 과정**이다. SWQM 역시 마지막 단계가 아니라 Cross-Cutting 과정이다.
...
DevOps, SW Project Management, SW Proposal, DT→AX는 Admission Gate를 통과해 Portfolio에 편입되었다. 이후 신규 과정은 새 OWNER 또는 충분히 큰 EXTEND 영역을 입증한 뒤 추가한다.
...
> **교재와 권고의 기본 기준은 Global Baseline이며, 국내 관행은 그 기준에서 재검토한다.**

국내 법·규제·계약·조달 등 적용 제약은 먼저 `Local/System Constraint`로 본다. 제거가 어렵다면 그 제약 안에서 전체 성과를 최적화한 Contextual Adaptation을 설명하고, 제약 제거 시의 preferred state를 함께 구분한다. BP/WP label은 교육상 필요한 경우에만 source policy에 따라 사용한다.
