# DDD Verified Principles & Sources Pack v2.0

> Purpose: DDD curriculum authoring에 사용할 foundational/authoritative source baseline.
> Policy: Global Baseline 우선. Pattern 이름보다 meaning / invariant / boundary / model evolution을 우선한다.
