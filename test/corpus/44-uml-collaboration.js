// 정상 — uml 다이어그램(collaboration/communication). 객체 간 협업 메시지를 그린다.
module.exports = {
  curriculum: [{ day: 'Day 1 — 유형', items: ['제목'] }],
  session: { no: 94, title: '코퍼스', toc: [['01', '학습 목표'], ['02', '현상'], ['03', '원칙'], ['04', '적용'], ['05', '요약']], slides: [
    ...
    { kind: '현상', title: 'uml collaboration 렌더', sub: 's', question: '누가 부르나?', lead: { label: 'l', text: 't' },
