// 결함 — bullets item.text의 rich-run 배열 원소가 { text, small? } 형태가 아니다(text 누락).
// shape.js conformField(kind:'richtext')가 잡아야 한다.
module.exports = {
  curriculum: [{ day: 'Day 1 — 유형', items: ['제목'] }],
  session: { no: 100, title: '코퍼스', toc: [['01', '학습 목표'], ['02', '현상'], ['03', '원칙'], ['04', '적용'], ['05', '요약']], slides: [
    ...
    { kind: '현상', title: 'rich-run 형태 오류', sub: 's', question: '무엇이 잘못됐나?', lead: { label: 'l', text: 't' },
