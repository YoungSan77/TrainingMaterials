# 6과정 공통 저작 규약
> 버전: v0.2 (§3 엔진 재사용 결정 확정 + 회귀 불변식 추가)
...
1장은 지도만 그렸다. 진단에서 확인한 보완 대상 중 다음 것들이 이어질 장의 후보다 — 순서는 논의로 정한다.

- **자세 선언 인용 규약**: 여섯 과정 1교시가 공유하는 "조건부 필요악·Just Enough·예방/상환" 문구가 이미 과정마다 조금씩 다르게 옮겨졌다. QM의 인용 자산(id·원문·축자 대조)과 같은 모양의 문제이므로 같은 해법(자산화 + 축자 대조 규율)을 옮겨 쓸 후보.
